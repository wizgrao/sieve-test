...
def build_index(config: SieveConfig) -> dict[str, List[str]]:
...
def main(functions: Annotated[List[str], typer.Argument()], config: str="sieve-config.yml", test_env: bool=False, deploy: bool=True, test: bool=True):
